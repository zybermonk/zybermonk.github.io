...
**G7 1. Base model:** 
$$
lm(log(gdp_g7) ~ log(cap_g7) + log(lab_g7), data = G7) 
$$
...
To start off, we use the above obtained α and β values to calculate level of technology or the technology factor using the formula `𝐴 =𝑌/(𝐾^𝛼𝐿^𝛽)`

Once the values of ‘A’ are found for both euro area and G7 nations, we perform further regressions to evaluate the effect of ‘A’ relative to the calculated TFP.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image2.png" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image3.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image4.png" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image5.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
**5.3 Analysis of all the previous models 354**
...
<div class="row mt-">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image6.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row mt-">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image7.png" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image8.png" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
## 6. Results and Further Research 373

I. The technological impact on the economic growth is very evident and it could have caused an exponential growth in the GDP. 
